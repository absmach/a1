...
The A1 is a next-generation Linux-based IoT Gateway that combines the strengths of the S0 IoT board and the BeagleV-Fire platform. Designed for smart metering and industrial IoT applications, the A1 gateway enables reliable and scalable data collection from Wireless M-Bus (wMBus).

![Beagle-V Fire](images/BeagleV-Fire.png)
...
This design allows the A1 to seamlessly integrate with Magistrala, enabling large-scale deployment in smart metering, utility monitoring, and industrial telemetry systems.
